...
@@@@@@@ custom tutor move types @@@@@@@@@@@@@@@@@
	.4byte Move_SIMPLE_STRIKE
	.4byte Move_CONVERSATION
	.4byte Move_LAVA_RUSH
	.4byte Move_CORE_MELTDOWN
	.4byte Move_MAELSTROM
	.4byte Move_PRESSURIZE
	.4byte Move_SPROUT_SHOT
	.4byte Move_VEGETATE
	.4byte Move_STATIC_SWIPES
	.4byte Move_IONIC_GAS
	.4byte Move_TRI_CHOP
	.4byte Move_FOCUS_CHI
	.4byte Move_SAND_SURF
	.4byte Move_EARTH_SWAP
	.4byte Move_WING_SLASH
	.4byte Move_GALE_FORCE
	.4byte Move_BOULDER_ROLL
	.4byte Move_CRYSTALLIZE
	.4byte Move_INSECTION
	.4byte Move_CHRYSALIS
	.4byte Move_CRYO_BURST
	.4byte Move_FREEZE_POWDER
	.4byte Move_NOXIOUS_CLAW
	.4byte Move_METASTASIZE
	.4byte Move_PSIONIC_SLAM
	.4byte Move_BRAIN_DRAIN
	.4byte Move_NECROMANCY
	.4byte Move_SPOOK
	.4byte Move_WYVERNS_WRATH
...
Move_NOXIOUS_CLAW::
	...
	createvisualtask AnimTask_BlendBackground, 6, 6, RGB(26, 0, 26)
	delay 16
	createsprite gHorizontalLungeSpriteTemplate, ANIM_ATTACKER, 2, 6, 4
	delay 2
	playsewithpan SE_W013, SOUND_PAN_TARGET
...
Move_WYVERNS_WRATH::
	...
	call DragonBloodBuffUp
	delay 0x8
	createsprite gWyvernsWrathOrbSlideSpriteTemplate, ANIM_ATTACKER, 1
	playsewithpan SE_W171, SOUND_PAN_ATTACKER
	waitforvisualfinish
	clearmonbg ANIM_ATTACKER
	blendoff
	delay 8
	createvisualtask AnimTask_WyvernsWrathFlame, 5, 0
	playsewithpan SE_W172B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	createvisualtask AnimTask_WyvernsWrathFlame, 5, 1
	playsewithpan SE_W172B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	createvisualtask AnimTask_WyvernsWrathFlame, 5, 2
	playsewithpan SE_W172B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	createvisualtask AnimTask_WyvernsWrathFlame, 5, 3
	playsewithpan SE_W172B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	createvisualtask AnimTask_WyvernsWrathFlame, 5, 4
	playsewithpan SE_W172B, SOUND_PAN_ATTACKER
	waitforvisualfinish
	delay 8
