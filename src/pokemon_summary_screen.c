...
static s8 AdvanceMonIndex(s8 delta) //added scrolling on sum screen
{
...
static void BufferLeftColumnStats(void)
{
	...
	const s8 *natureMod = gNatureStatTable[sMonSummaryScreen->summary.nature]; //Alloc from 8 to 20 and add this line for color natures
	...
	BufferStat(currentHPString, 0, sMonSummaryScreen->summary.currentHP, 0, 3); //This +next 3 lines for nature color
