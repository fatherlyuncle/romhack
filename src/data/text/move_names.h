const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_FALSE_SURRENDER] = _("False Surren"),
    [MOVE_METEOR_ASSAULT] = _("Meteor Ass."),
    [MOVE_ETERNABEAM] = _("Eternabeam"),
    [MOVE_STEEL_BEAM] = _("Steel Beam"),
	//Custom move tutor type mvoes
	[MOVE_SIMPLE_STRIKE] = _("SimpleStrike"),
	[MOVE_CONVERSATION] = _("Conversation"),
	[MOVE_LAVA_RUSH] = _("Lava Rush"),
	[MOVE_CORE_MELTDOWN] = _("CoreMeltdown"),
	[MOVE_MAELSTROM] = _("Maelstrom"),
	[MOVE_PRESSURIZE] = _("Pressurize"),
	[MOVE_SPROUT_SHOT] = _("Sprout Shot"),
	[MOVE_VEGETATE] = _("Vegetate"),
	[MOVE_STATIC_SWIPES] = _("StaticSwipes"),
	[MOVE_IONIC_GAS] = _("Ionic Gas"),
	[MOVE_TRI_CHOP] = _("Tri Chop"),
	[MOVE_FOCUS_CHI] = _("Focus Chi"),
	[MOVE_SAND_SURF] = _("Sand Surf"),
	[MOVE_EARTH_SWAP] = _("Earth Swap"),
	[MOVE_WING_SLASH] = _("Wing Slash"),
	[MOVE_GALE_FORCE] = _("Gale Force"),
	[MOVE_BOULDER_ROLL] = _("Boulder Roll"),
	[MOVE_CRYSTALLIZE] = _("Crystallize"),
    [MOVE_INSECTION] = _("Insection"),
	[MOVE_CHRYSALIS] = _("Chrysalis"),
	[MOVE_CRYO_BURST] = _("Cryo Burst"),
	[MOVE_FREEZE_POWDER] = _("FreezePowder"),
	[MOVE_NOXIOUS_CLAW] = _("Noxious Claw"),
	[MOVE_METASTASIZE] = _("Metastasize"),
	[MOVE_PSIONIC_SLAM] = _("Psionic Slam"),
	[MOVE_BRAIN_DRAIN] = _("Brain Drain"),
	[MOVE_NECROMANCY] = _("Necromancy"),
	[MOVE_SPOOK] = _("Spook"),
	[MOVE_WYVERNS_WRATH] = _("WyvernsWrath"),
	[MOVE_DRAGON_BLOOD] = _("Dragon Blood"),
	[MOVE_DEMONIC_HOWL] = _("Demonic Howl"),
	[MOVE_MURKY_STARE] = _("Murky Stare"),
	[MOVE_MERCURY_BODY] = _("Mercury Body"),                
	[MOVE_NANOBOTS] = _("Nanobots"),
	[MOVE_PIXIE_DUST] = _("Pixie Dust"),
	[MOVE_LUNAR_CURSE] = _("Lunar Curse"),
};
